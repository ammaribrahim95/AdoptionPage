        ...
        <footer className="bg-[#b75960] text-white py-12 mt-auto">
            <div className="container mx-auto px-6 max-w-5xl flex flex-col items-center text-center">
                ...
                <div className="mb-6 flex flex-col items-center">
                    <img src="/favicon.png" alt="The A Pawstrophe Logo" className="w-40 h-40 -mt-12 -mb-2 object-cover drop-shadow-md relative z-10" />
                ...
                <div className="flex flex-wrap justify-center gap-6 mb-12 text-sm font-bold text-white/80">
                    ...
                    <Link href="/available" className="hover:text-white transition-colors">Available Pets</Link>
                    <Link href="/adopted" className="hover:text-white transition-colors">Success Stories</Link>
