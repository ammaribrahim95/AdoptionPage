...
import { Check, Heart, Share2, Copy } from 'lucide-react'
                ...
                <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="text-sm font-bold flex items-center gap-1 bg-slate-50 px-2.5 py-1 rounded border border-slate-100 shadow-sm">
                        ...
                        {pet.gender?.toLowerCase() === 'male' ? (
                            <img src="/male.png" alt="Male" className="w-2.5 h-2.5 inline-block" />
                        ) : pet.gender?.toLowerCase() === 'female' ? (
                            <img src="/female.png" alt="Female" className="w-2.5 h-2.5 inline-block" />
                        ) : null}
                    </span>
                </div>
